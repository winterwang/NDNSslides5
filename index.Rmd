...
- Three distinct temporal eating patterns were identified (next 2 slides) in both Australian poulation (Leech *et al* 2017, Int J Behav Nutr Phys Act) and general population in the UK.
...
- .medium[Target population for this project: adults, age range 19-64 years (sample size: 3662).] 
    - Year 1-4: 1126 men and 1571 women
    - Year 5-6: 373 men and 592 women
...
- For every hour of the day whether an EO had occurred need to be calculated individually.
...
- Association between the eating pattern groups defined by CLA and obesity/diabetes will be explored through logistic regression models.

???

The statistical method here we are going to use is Latent class analysis. I will need to go through the methodology of this technique and clarify the differences and similarities of LCA with cluster analysis and principal component analysis.
